...
Source0  : https://files.pythonhosted.org/packages/cc/25/fc285fbd470559e775dad4990f99a52305976ed4dba299bd7e44ba6aaa71/types-toml-0.10.8.5.tar.gz
...
%prep
%setup -q -n types-toml-0.10.8.5
cd %{_builddir}/types-toml-0.10.8.5
pushd ..
cp -a types-toml-0.10.8.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676998872
