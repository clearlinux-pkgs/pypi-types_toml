...
Source0  : https://files.pythonhosted.org/packages/70/03/1f06c5352c042214dd06c5d0b5ed4e495e383d5cb7276e4e99243583ac05/types-toml-0.10.8.4.tar.gz
...
%prep
%setup -q -n types-toml-0.10.8.4
cd %{_builddir}/types-toml-0.10.8.4
pushd ..
cp -a types-toml-0.10.8.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676476711
