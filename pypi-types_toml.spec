...
Source0  : https://files.pythonhosted.org/packages/01/59/966378cfc0cb02e24ccaa7c1029cca5821f94f40a9c4649095b61890cd9a/types-toml-0.10.8.2.tar.gz
...
%prep
%setup -q -n types-toml-0.10.8.2
cd %{_builddir}/types-toml-0.10.8.2
pushd ..
cp -a types-toml-0.10.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675378886
