...
Source0  : https://files.pythonhosted.org/packages/79/25/20a49e2c341b5438d46aea4f8cfa152bdebdd47385dfd8084a9682b90d8b/types-toml-0.10.8.3.tar.gz
...
%prep
%setup -q -n types-toml-0.10.8.3
cd %{_builddir}/types-toml-0.10.8.3
pushd ..
cp -a types-toml-0.10.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675786380
